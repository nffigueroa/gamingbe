...
var SpeedLogic = /** @class */ (function () {
    function SpeedLogic() {
        this.URL = "https://partes.speedlogic.com.co/";
        this.COMPANY_NAME = "speedlogic";
    }
    SpeedLogic.prototype.getTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connect(this.URL, "#SPEED_17140 > table")];
                    case 1:
                        response = _a.sent();
    ...
    SpeedLogic.prototype.connect = function (url, tableTarget) {
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, page.evaluate(function (table, company) {
                                ...
                                rows.forEach(function (item, index) {
                                    ...
                                    var nameA = item.querySelectorAll("td")[0].innerText;
                                    var valueA = item
                                    ...
                                    var nameB = item.querySelectorAll("td")[3].innerText;
                                    var valueB = item
