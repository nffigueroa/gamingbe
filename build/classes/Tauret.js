...
var Tauret = /** @class */ (function () {
    function Tauret() {
        this.URL = "https://tauretcomputadores.com/lista-de-precios";
        this.COMPANY_NAME = "tauretcomputadores";
    }
    Tauret.prototype.getTable = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connect(this.URL, "#areaImprimir > div", "")];
                    case 1:
                        response = _a.sent();
    ...
    Tauret.prototype.connect = function (url, tableTarget, tr) {
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, page.evaluate(function (table, company) {
                                ...
                                for (var i = 1; i < rows.length; i++) {
                                    var grid = rows[i].querySelectorAll("#areaImprimir > div > div:nth-child(" + (i + 1) + ") > div.product_prod");
